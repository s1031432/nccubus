...
data.zoo_nccu1.str = getData("zoo_nccu1");
...
data.nccu_zoo.str = getData("nccu_zoo");
...
data.nccu1_zoo.str = getData("nccu1_zoo");
...
data.xinguang.str = getData("xinguang");
